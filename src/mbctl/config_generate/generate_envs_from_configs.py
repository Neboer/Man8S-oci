...
from mbctl.utils.datetime_tools import get_current_iso_datetime
from mbctl.utils.shell import args_list_to_command
from mbctl import __version__ as mbctl_version
...
def generate_env_config_from_configs(
    ...
    env_config["MAN8S_MBCTL_VERSION"] = mbctl_version
    env_config["MAN8S_MBCTL_CREATED_AT"] = get_current_iso_datetime()
